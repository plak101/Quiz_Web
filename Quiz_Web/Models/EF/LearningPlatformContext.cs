...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-3Q3UNK4\\MSSQLSERVER01;;Initial Catalog=LearningPlatform;Persist Security Info=True;User ID=solar;Password=@Abcd@1234;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AttemptAnswerId).HasName("PK__AttemptA__EC6FE54E251246D0");
        ...
        {
            entity.HasKey(e => e.AuditId).HasName("PK__AuditLog__A17F2398F87F9201");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B0A012B5E9F");
        ...
        {
            entity.HasKey(e => e.CertId).HasName("PK__Certific__E5BD38C56478BB1C");
        ...
        {
            entity.HasKey(e => e.ShareId).HasName("PK__ContentS__D32A3FEEDD99599C");
        ...
        {
            entity.HasKey(e => e.ContentTagId).HasName("PK__ContentT__8FE57485A2448D70");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__C92D71A70D78338A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__CourseCa__19093A0B0C07C934");

            entity.HasIndex(e => e.Slug, "UQ__CourseCa__BC7B5FB641496F73").IsUnique();
        ...
        {
            entity.HasKey(e => e.ChapterId).HasName("PK__CourseCh__0893A36A9CFDA4FB");
        ...
        {
            entity.HasKey(e => e.ProgressId).HasName("PK__CoursePr__BAE29CA57A880629");
        ...
        {
            entity.HasKey(e => e.PurchaseId).HasName("PK__CoursePu__6B0A6BBEC7D238B5");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__CourseRe__74BC79CEC6928163");
        ...
        {
            entity.HasKey(e => e.ErrorId).HasName("PK__ErrorLog__35856A2A6ABFDA2E");
        ...
        {
            entity.HasKey(e => e.FileId).HasName("PK__Files__6F0F98BF8A4D97F9");
        ...
        {
            entity.HasKey(e => e.CardId).HasName("PK__Flashcar__55FECDAE88AAAE22");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Flashcar__5E548648FC5BB835");
        ...
        {
            entity.HasKey(e => e.SetId).HasName("PK__Flashcar__7E08471DEEE6B8A5");
        ...
        {
            entity.HasKey(e => e.FolderId).HasName("PK__Folders__ACD7107F62904BAB");
        ...
        {
            entity.HasKey(e => e.LessonId).HasName("PK__Lessons__B084ACD01C6DA386");
        ...
        {
            entity.HasKey(e => e.ContentId).HasName("PK__LessonCo__2907A81ED44EF686");
        ...
        {
            entity.HasKey(e => e.LibraryId).HasName("PK__Librarie__A136475F1C3C7EC8");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E128E6A6447");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A38DE8FA70D");
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__Question__0DC06FACD2DF4982");
        ...
        {
            entity.HasKey(e => e.BlankId).HasName("PK__Question__F2BD63E78E599C73");
        ...
        {
            entity.HasKey(e => e.OptionId).HasName("PK__Question__92C7A1FF41BF01F2");
        ...
        {
            entity.HasKey(e => e.RangeId).HasName("PK__Question__6899CA142A4130E3");
        ...
        {
            entity.HasKey(e => e.ReminderId).HasName("PK__Reminder__01A830870603F0EA");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A3BA8032A");

            entity.HasIndex(e => e.Name, "UQ__Roles__737584F691CE7647").IsUnique();
        ...
        {
            entity.HasKey(e => e.SavedItemId).HasName("PK__SavedIte__1CBC88C8F39C860D");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Shopping__51BCD7B723904CAB");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tags__657CF9ACDAD98B83");

            entity.HasIndex(e => e.Name, "UQ__Tags__737584F62C8CC41B").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Tags__BC7B5FB69E274E78").IsUnique();
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__Tests__8CC331609F990656");
        ...
        {
            entity.HasKey(e => e.AttemptId).HasName("PK__TestAtte__891A68E653FAF7F1");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C3A476DD8");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534FF39A388").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserInterestId).HasName("PK__UserInte__28E6EBFE4BA3D171");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserProf__1788CC4CB95D5455");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserSett__1788CC4CB8F8CBB1");
